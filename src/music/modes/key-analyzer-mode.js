/**
 * Key analysis mode - detects notes and musical key
 */
class KeyAnalyzerMode extends MusicAnalyzerMode {
    ...
    initialize() {
        console.log("[KEY MODE] Initialized");
    }
    ...
    processData(data) {
        ...
        console.log("[KEY MODE] Displaying detected key:", data.key ? data.key.name : 'Unknown');
        console.log("[KEY MODE] Detected notes:", data.notes);
...
window.KeyAnalyzerMode = KeyAnalyzerMode;
